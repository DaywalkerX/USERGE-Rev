...
Hello There {f_name}, I'm {bot.first_name}
         <i><b>I can't do much without my Master's permission, here's a way to contact him: </i> <b>{master.first_name}</b>
"""
        ...
        try:
            await userge.bot.send_cached_media(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton("Heart Of Me", url=f"https://t.me/joinchat/Mv0VXzG9iM1mYjU8"),
                            InlineKeyboardButton("REPO", url="https://github.com/code-rgb/USERGE-X"),
                            InlineKeyboardButton(
                                "Koony Town", url=f"https://t.me/joinchat/tPRtaNt-obZmOWQ5"
                            ),
                        ],
                    ]
                 ),
